...
int sm2_create_key_pair(SM2_KEY_PAIR *key_pair)
{
	...
	//print_HexString(key_pair->pri_key,sizeof(key_pair->pri_key),"key_pair->pri_key");
	//memcpy(key_pair->pri_key,import_priv,sizeof(key_pair->pri_key));
	//print_HexString(key_pair->pri_key,sizeof(key_pair->pri_key),"key_pair->pri_key");
	key_pair->pub_key[0] = 0x4;
	//print_HexString(pub_key_x,sizeof(pub_key_x),"pub_key_x");
	//print_HexString(pub_key_y,sizeof(pub_key_y),"pub_key_y");	
	//memcpy(pub_key_x,import_Xa,sizeof(pub_key_x));
	//memcpy(pub_key_y,import_Ya,sizeof(pub_key_y));
